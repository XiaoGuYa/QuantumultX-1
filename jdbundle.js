...
class Stall {
    ...
    list() {
        ...
        <button class="group" style="width: 120px;height:30px;background-color: #2196F3;border-radius: 5px;border: 0;color:#fff;margin:5px auto;display:block">获取我的商圈分享链接</button>
        ...
        const o = utils_1._$('.signIn'), others = utils_1._$('.others'), group = utils_1._$('.group'), master = utils_1._$('.master'), h = utils_1._$('.help'), a = utils_1._$('.funny'), v = utils_1._$('.viewProduct'), r = utils_1._$('.record'), s = utils_1._$('.shopping'), i = utils_1._$('.invite'), g = utils_1._$('.goodShopping'), b = utils_1._$('.raise'), browser = utils_1._$('.browser'), assistGroup = utils_1._$('.assistGroup'), helpGroup = utils_1._$('.helpGroup'), assist = utils_1._$('.assist'), p = utils_1._$('.addproduct');
        ...
        master.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!taskVos || taskVos["status"] == 2) {
                ...
                utils_1.default.outPutLog(this.outputTextarea, `开始每天主会场任务`);
        ...
        s.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!taskVos || taskVos["status"] == 2) {
                ...
                utils_1.default.outPutLog(this.outputTextarea, `开始自动逛逛会场任务`);
                yield this.send(taskVos["shoppingActivityVos"], taskVos["taskId"]);
                this.updateTask();
            }
        }));
        g.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!taskVos || taskVos["status"] == 2) {
                ...
                utils_1.default.outPutLog(this.outputTextarea, `开始自动逛逛好物会场任务`);
                yield this.send(taskVos["shoppingActivityVos"], taskVos["taskId"]);
                this.updateTask();
            }
        }));
        a.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!taskVos || taskVos["status"] == 2) {
                ...
                utils_1.default.outPutLog(this.outputTextarea, `开始自动好玩互动任务`);
                yield this.send(taskVos["shoppingActivityVos"], taskVos["taskId"]);
                this.updateTask();
            }
        }));
        others.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!taskVos || taskVos["status"] == 2) {
                ...
                utils_1.default.outPutLog(this.outputTextarea, `开始自动浏览其他活动任务`);
    ...
    single(taskId, itemId) {
        var postData = { "taskId": 1, "itemId": "1", "ss": `{\"extraData\":{},\"businessData\":{\"taskId\":1,\"rnd\":\"\",\"inviteId\":\"-1\",\"stealId\":\"-1\"},\"secretp\":\"${this.secretp}\"}`, "shopSign": "" };
    ...
    browser(data, taskId) {
        return __awaiter(this, void 0, void 0, function* () {
            let self = this, length = data.length;
            for (let i = 0; i < length; i++) {
                var postData = { "taskId": taskId, "itemId": data[i]['itemId'], "actionType": "1", "ss": `{\"extraData\":{},\"businessData\":{\"taskId\":${taskId},\"rnd\":\"\",\"inviteId\":\"-1\",\"stealId\":\"-1\"},\"secretp\":\"${this.secretp}\"}`, "shopSign": "" };
                yield new Promise(resolve => {
                    setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                        yield fetch("https://api.m.jd.com/client.action?functionId=stall_collectScore", {
                            ...
                            this.request('followShop', { "shopId": data[i]['shopId'], "follow": true, "type": "0" }).then(() => {
                                utils_1.default.outPutLog(self.outputTextarea, `等待8s任务完成后再领取奖励中`);
                                setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                                    this.request('stall_collectScore', { "taskId": taskId, "itemId": data[i]['itemId'], "ss": `{\"extraData\":{},\"businessData\":{\"taskId\":${taskId},\"rnd\":\"\",\"inviteId\":\"-1\",\"stealId\":\"-1\"},\"secretp\":\"${this.secretp}\"}`, "shopSign": "" }).then(() => {
                ...
                yield new Promise(resolve => {
                    setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                        yield fetch("https://api.m.jd.com/client.action", {
                            ...
                            utils_1.default.outPutLog(self.outputTextarea, `模拟浏览商品中!`);
                            let totalCounter = 5;
                            for (let j = 0; j < totalCounter; j++) {
                                let productInfoVos = res.data.result.viewProductVos[i].productInfoVos, productInfoVo = productInfoVos[j], taskId = res.data.result.addProductVos[i]['taskId'];
                                yield new Promise(resolveFn => {
                                    setTimeout(() => {
                                        this.request('stall_collectScore', { "taskId": taskId, "itemId": productInfoVo['itemId'], "ss": `{\"extraData\":{},\"businessData\":{\"taskId\":${taskId},\"rnd\":\"\",\"inviteId\":\"-1\",\"stealId\":\"-1\"},\"secretp\":\"${this.secretp}\"}`, "shopSign": "" }).then(() => {
                                            resolveFn();
                                            utils_1.default.outPutLog(self.outputTextarea, `浏览商品完成!`);
                                            if (j >= totalCounter - 1) {
                                                utils_1.default.outPutLog(self.outputTextarea, `操作成功！任务序号：${i + 1}/${length}`);
                                                if (i + 1 >= length) {
                                                    utils_1.default.outPutLog(self.outputTextarea, `当前任务已完成!`);
                        ...
                        yield fetch("https://api.m.jd.com/client.action?functionId=stall_collectScore", {
                            ...
                            if (flag) {
                                ...
                                if (res.data.result) {
                                    setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                                        utils_1.default.outPutLog(self.outputTextarea, `等待8s任务完成后再领取奖励中`);
                                        this.request('qryViewkitCallbackResult', { "clientLanguage": "zh", "dataSource": "newshortAward", "method": "getTaskAward", "reqParams": `{\"taskToken\":\"${res.data.result.taskToken}\"}`, "taskSDKVersion": "1.0.3", "vkVersion": "1.0.0" }).then(() => {
                                            utils_1.default.outPutLog(self.outputTextarea, `操作成功！任务序号：${i + 1}/${length}`);
                                            if (i + 1 >= length) {
                                                utils_1.default.outPutLog(self.outputTextarea, `当前任务已完成!`);
                                            }
    ...
    join() {
        fetch("https://api.m.jd.com/client.action?functionId=bombnian_pk_joinGroup", {
            ...
            if (res.data.bizCode == 0) {
                utils_1.default.outPutLog(this.outputTextarea, `操作成功！加入成功！`);
            }
            else {
                utils_1.default.outPutLog(this.outputTextarea, `操作失败，好像满人了哦`);
            }
        });
    }
    raise() {
    ...
    getInvite() {
        fetch('https://api.m.jd.com/client.action', {
            ...
            body: `functionId=stall_getTaskDetail&body=${JSON.stringify({ "shopSign": "" })}&client=wh5&clientVersion=1.0.0`
        }).then((res) => res.json())
            .then((json) => {
            const inviteId = json.data.result.inviteId.replace("#/", "");
            if (inviteId) {
                utils_1.default.outPutLog(this.outputTextarea, `获取到邀请id:${inviteId}`);
                utils_1.default.copyText(`https://bunearth.m.jd.com/babelDiy/Zeus/4SJUHwGdUQYgg94PFzjZZbGZRjDd/index.html?shareType=homeTask&inviteId=${inviteId}`);
            }
            else {
    ...
    help() {
        utils_1.default.outPutLog(this.outputTextarea, `操作成功！谢谢你助力！`);
    ...
    group() {
        fetch('https://api.m.jd.com/client.action', {
            ...
            if (groupAssistInviteId) {
                utils_1.default.outPutLog(this.outputTextarea, `获取到邀请id:${groupAssistInviteId}`);
                utils_1.default.copyText(`https://bunearth.m.jd.com/babelDiy/Zeus/4SJUHwGdUQYgg94PFzjZZbGZRjDd/index.html?shareType=cbdDay&inviteId=${groupAssistInviteId}`);
            }
            else {
    ...
    assistGroup(url) {
        ...
        let jsonData = { "confirmFlag": 1, "inviteId": `${inviteId}`, "ss": `{\"extraData\":{},\"businessData\":{\"taskId\":\"2\",\"rnd\":\"\",\"inviteId\":\"${inviteId}\",\"stealId\":\"-1\"},\"secretp\":\"${this.secretp}\"}` };
        ...
        fetch('https://api.m.jd.com/client.action?functionId=stall_pk_assistGroup', {
            ...
            .then((json) => {
            utils_1.default.outPutLog(this.outputTextarea, `助力结果：${json.data.bizMsg}`);
        });
    }
    assist(url) {
        if (!url && !url.includes('inviteId')) {
        ...
        const inviteId = utils_1.default.getSearchString(url, "inviteId").replace("#/", "");
        this.request('stall_getHomeData', { "inviteId": inviteId }).then((json) => json.json()).then((res) => {
            const itemId = res.data.result.homeMainInfo.guestInfo.itemId;
            let jsonData = { "taskId": "2", "itemId": itemId, "ss": `{\"extraData\":{},\"businessData\":{\"taskId\":\"2\",\"rnd\":\"\",\"inviteId\":\"${inviteId}\",\"stealId\":\"-1\"},\"secretp\":\"${this.secretp}\"}`, "inviteId": inviteId };
...
},{"../config/config":2,"../utils/utils":26}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class Config {
}
...
function buildActivity() {
    ...
    <p style="color:red;font-weight:bold;"><a style="color:red" href="https://bunearth.m.jd.com/babelDiy/Zeus/4SJUHwGdUQYgg94PFzjZZbGZRjDd/index.html?babelChannel=1#/home" target="_blank">全民营业</a></p>`;
